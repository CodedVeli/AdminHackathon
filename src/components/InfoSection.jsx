    ...
    <section className="scroll-mt-24" id="features">
      <div className="h-full px-8 py-24 mx-auto md:px-12 lg:px-32 max-w-7xl">
        <div className="text-center">
          <h2 className="text-4xl  font-semi-bold tracking-tighter text-gray-900">
            Why Participate in{" "}
            <span className="text-[#0FA958]">AI Challenges?</span>
          </h2>
        </div>
        <div className="grid gap-6 mt-12 md:grid-cols-2">
          <div className="flex flex-col gap-4 p-8 rounded-xl bg-[#F8F9FD]">
            ...
            <h1 className=" text-2xl font-semi-bold">Prove your skills</h1>
            <div>
          ...
          <div className="flex flex-col gap-4 p-8 rounded-xl bg-[#F8F9FD]">
            ...
            <h1 className=" text-2xl font-semi-bold">Learn from Community</h1>
            <div>
              <p className="mt-2  text-base text-gray-500">
          ...
          <div className="flex flex-col gap-4 p-8 rounded-xl bg-[#F8F9FD]">
            ...
            <h1 className=" text-2xl font-semi-bold">Challenge yourself</h1>
            <div>
              <p className="mt-2  text-base text-gray-500">
...
<path d="M46.4062 10.3125H8.59375C7.64451 10.3125 6.875 11.082 6.875 12.0312V42.9688C6.875 43.918 7.64451 44.6875 8.59375 44.6875H46.4062C47.3555 44.6875 48.125 43.918 48.125 42.9688V12.0312C48.125 11.082 47.3555 10.3125 46.4062 10.3125Z" stroke="#0FA958" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <h1 className=" text-2xl font-semi-bold">Earn recognition</h1>
            <div>
              <p className="mt-2  text-base text-gray-500">
                Earn recognition You will stand out from the crowd if you do
                well in AI challenges, it not only helps you shine in the
